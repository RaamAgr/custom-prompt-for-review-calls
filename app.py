# app.py — FINAL VALIDATED CODE
# -----------------------------------------------------------------------------
# 1. USES DOT NOTATION (st.sidebar.x) -> Eliminates indentation errors.
# 2. PROMPT EDITOR -> Forced to Main Page.
# -----------------------------------------------------------------------------
...
def main():
    ...
    # ==========================
    # 1. SIDEBAR SETTINGS (Use dot notation)
    # ==========================
    ...
    # Prompt Editor (Guaranteed Main Page via st.text_area)
