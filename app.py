...
# 7. UI UPDATE: System Prompt Editor moved to Main Screen.
# -----------------------------------------------------------------------------
...
MODEL_NAME = "gemini-3-flash-preview"  # RESTORED TO ORIGINAL
...
def main():
    ...
    st.markdown("Upload Excel files with audio URLs to process them using Gemini 1.5 Flash.")
